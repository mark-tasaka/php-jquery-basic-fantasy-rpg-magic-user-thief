...
<html>
<head>
<title>Launch Page: Basic Fantasy RPG Magic-User/Thief Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="magic_thiefForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Magic-User/Thief</option>
				<option value="2">2nd Level, Magic-User/Thief</option>
				<option value="3">3rd Level, Magic-User/Thief</option>
				<option value="4">4th Level, Magic-User/Thief</option>
				<option value="5">5th Level, Magic-User/Thief</option>
				<option value="6">6th Level, Magic-User/Thief</option>
				<option value="7">7th Level, Magic-User/Thief</option>
				<option value="8">8th Level, Magic-User/Thief</option>
				<option value="9">9th Level, Magic-User/Thief</option>
				<option value="10">10th Level, Magic-User/Thief</option>
				<option value="11">11th Level, Magic-User/Thief</option>
				<option value="12">12th Level, Magic-User/Thief</option>
				<option value="13">13th Level, Magic-User/Thief</option>
				<option value="14">14th Level, Magic-User/Thief</option>
				<option value="15">15th Level, Magic-User/Thief</option>
				<option value="16">16th Level, Magic-User/Thief</option>
				<option value="17">17th Level, Magic-User/Thief</option>
				<option value="18">18th Level, Magic-User/Thief</option>
				<option value="19">19th Level, Magic-User/Thief</option>
				<option value="20">20th Level, Magic-User/Thief</option>
			  </select>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#magic_thiefForm").attr('action', "character/basic_magic_thief" + $("#abilityScores").val() +  ".php");
